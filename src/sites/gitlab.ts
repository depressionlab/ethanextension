...
const repositoryMainImplementation: ReplacementSelectorSet = {
	...
	isDirectory: (_rowEl, _fileNameEl, iconEl) => iconEl.classList.contains('folder-icon'),
	isSubmodule: (_rowEl, fileNameEl, _iconEl) => fileNameEl.classList.contains('is-submodule'),
...
const commitDiffFileHeaderImplementation: ReplacementSelectorSet = {
	...
	isDirectory: (_rowEl, _fileNameEl, iconEl) => iconEl.classList.contains('folder-icon'),
	isSubmodule: (_rowEl, _fileNameEl, iconEl) => iconEl.getAttribute('data-testid') === 'folder-git-icon',
	isCollapsable: (_rowEl, _fileNameEl, _iconEl) => false,
};
...
const mergeRequestsTreeImplementation: ReplacementSelectorSet = {
	...
	isDirectory: (rowEl, _fileNameEl, _iconEl) => rowEl.classList.contains('folder'),
	isSubmodule: (_rowEl, _fileNameEl, iconEl) => iconEl.firstElementChild!.getAttribute('href')!.endsWith('#folder-git'),
	isCollapsable: (rowEl, fileNameEl, iconEl) => mergeRequestsTreeImplementation.isDirectory(rowEl, fileNameEl, iconEl),
};
