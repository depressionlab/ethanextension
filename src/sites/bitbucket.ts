...
const mainRepositoryImplementation: ReplacementSelectorSet = {
	...
	icon: 'svg',
	isDirectory: (_rowEl, _fileNameEl, iconEl) => iconEl.parentElement!.getAttribute('aria-label') === 'Directory,',
...
const directoryContentsHeaderImplementation: ReplacementSelectorSet = {
	...
	filename: 'div:has(span[aria-label="Directory,"] svg) + span > span:last-of-type',
