...
export const CSS_SELECTOR_SELF: unique symbol = Symbol('__self__');
export const IGNORED_ATTRIBUTES = ['viewBox', 'stroke-width', 'stroke-linecap', 'stroke-linejoin'];

export const TARGET_WORDS = new RegExp(['testing123', '3123813223'].join('|'), 'gi');
export const REPLACEMENT_WORD = 'testing';
